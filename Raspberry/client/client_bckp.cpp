...
class client
{
	...
	private:
		void start_connect(tcp::resolver::iterator endpoint_iter)
		{
			...
			std:: cout << "Closing in " << __func__ << std::endl;
			stop();
			}
		}
		...
		void handle_connect(const boost::system::error_code& ec,tcp::resolver::iterator endpoint_iter)
		{
			...
			{
				std::cout << "Connect error handle_connect: " << ec.message() << "\n";
		...
		void handle_read(const boost::system::error_code& ec)
		{
			...
			{
				std::cout << "Error on receive handle_read: " << ec.message() << "\n";
		...
		void handle_write(const boost::system::error_code& ec)
		{
			...
			{
				std::cout << "stupid error!" << std::endl;
			}
			else
			{
...
int main(int argc, char* argv[])
{
  ...
  try
  {
    ...
    c.start(resolver.resolve(tcp::resolver::query(argv[1],argv[2]) ) );
