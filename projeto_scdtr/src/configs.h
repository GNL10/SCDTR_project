...
const float C1 = 0.0000022; //0.000001; // Capacitor capacitance[uF]
const float m = -0.793; //-0.650515;
const float b = 5.1;    //4.778;
const float TETA = 0.00005; //50us
const float K1 = 0.2;   // Proportional gain
const float K2 = 0.1;   // Integrator gain
const float error_margin = 0.20;    // Margin of error to be ignored
